        ...
        <div class="inner-wrapper">
                                    ...
                                    <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                                        <div class="simplebar-content" style="padding: 16px;">
                                            <nav class="nav nav-pills nav-gap-y-1 flex-column">
                                                <a href="{{ url('/') }}" class="nav-link nav-link-faded has-icon">All posts</a>
                                                @foreach($categories as $category)
                                                    @if ($category->id == $actualCategory->id)
                                                        <a href="{{ url('category/' . $category->id) }}" class="nav-link nav-link-faded has-icon active">{{ $category->name }}</a>
                                                    @else
            ...
            <div class="inner-main">
                ...
                <div class="inner-main-header">
                    <a class="btn btn-success has-icon btn-block text-white" type="button" data-toggle="modal" data-target="#threadModal">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mr-2">
                            <line x1="12" y1="5" x2="12" y2="19"></line>
                            <line x1="5" y1="12" x2="19" y2="12"></line>
                        </svg>
                    ...
                    <form action="{{ url('post') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required value="{{ old('title') }}" type="text" class="form-control" name="title" placeholder="Enter title" minlength="2" minlength="60"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea required class="form-control summernote" rows="10" name="message" minlength="4">{{ old('message') }}</textarea>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ url('category') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-dismiss="modal">Cancel</button>
                                <input type="submit" class="btn btn-primary" value="Create category"></button>
                            </div>
                        </div>
                    </form>
                    @else
...
@section('scripts')
    ...
    @if ($errors->has('category') || $errors->has('title') || $errors->has('message') || $errors->has('postCreateError'))
        <script>
            $(function() {
                console.log('Working');
